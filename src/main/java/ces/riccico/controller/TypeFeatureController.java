...
//	Add TypeFeature
	@RequestMapping(value = "/createTypeFeature/{idTyperoom}", method = RequestMethod.POST)
	@PreAuthorize("hasAnyAuthority('admin')")
	public ResponseEntity<?> createTypeFeature(@RequestBody TypeFeature typeFeature, @PathVariable Integer idTyperoom) {
		return typeFeatureService.createTypeFeature(typeFeature, idTyperoom);
	}
...
//	Delete TypeFeature
	@RequestMapping(value = "/deleteTypeFeature/{idTypefeature}", method = RequestMethod.DELETE)
	@PreAuthorize("hasAnyAuthority('admin')")
	public ResponseEntity<?> deleteTypeFeature(@PathVariable Integer idTypefeature) {
		return typeFeatureService.deleteTypeFeature(idTypefeature);
